...
var _vertices = _Symbol("vertices");
var _edges = _Symbol("edges");
var _reverseEdges = _Symbol("reverse edges");
var _sources = _Symbol("sources");
var _sinks = _Symbol("sinks");
var _edgeCount = _Symbol("edge count");

var _listeners = _Symbol("listeners");
var _trigger = _Symbol("trigger");

var _verticesFrom = _Symbol("vertices from");
var _verticesTo = _Symbol("vertices to");
var _verticesWithPathTo = _Symbol("vertices with path to");
var _verticesWithPathFrom = _Symbol("vertices with path from");
var _paths = _Symbol("paths");

var _expectVertices = _Symbol("expect vertices");
var _expectVerticesAbsent = _Symbol("expect vertex absent");
var _expectEdges = _Symbol("expect edge");
var _expectEdgesAbsent = _Symbol("expect edge absent");
var _expectNoConnectedEdges = _Symbol("expect no connected edges");
...
var Graph = (function () {
	function Graph() {
		...
		/* storage */
		this[_vertices] = new _Map(); // Map.< string, * >
		this[_edges] = new _Map(); // Map.< string, Map.<string, *> >

		/* bookkeeping */
		this[_reverseEdges] = new _Map(); // Map.< string, Set.<*> >
		this[_sources] = new _Set(); // Set.< string >
		this[_sinks] = new _Set(); // Set.< string >
		this[_edgeCount] = 0;

		/* listeners */
		this[_listeners] = new _Map();
  ...
  */
	...
	_createClass(Graph, [{
		...
		value: function on(event, handler) {
			if (!this[_listeners].has(event)) {
				this[_listeners].set(event, new _Set());
			}
   ...
   */
		...
		value: function value(event, _value) {
			...
			try {
				for (var _iterator2 = _getIterator(this[_listeners].get(event) || []), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
   ...
   */
		...
		value: function addNewVertex(key, value) {
			...
			this[_edges].set(key, new _Map());
			this[_reverseEdges].set(key, new _Set());
   ...
   */
		...
		value: function destroyExistingVertex(key) {
			...
			try {
				for (var _iterator3 = _getIterator(this.verticesFrom(key)), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
			...
			try {
				for (var _iterator4 = _getIterator(this.verticesTo(key)), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
			...
			return _regeneratorRuntime.wrap(function vertices$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						...
						context$2$0.prev = 4;
						_iterator5 = _getIterator(this[_vertices]);
   ...
   */
		...
		value: _regeneratorRuntime.mark(function edges() {
			...
			return _regeneratorRuntime.wrap(function edges$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						done = new _Map();
						...
						context$2$0.prev = 4;
						_iterator6 = _getIterator(this[_edges].keys());
					...
					case 6:
						...
						done.set(from, new _Set());
						_iteratorNormalCompletion7 = true;
						_didIteratorError7 = false;
						_iteratorError7 = undefined;
						context$2$0.prev = 12;
						_iterator7 = _getIterator(this[_edges].get(from).keys());
   ...
   */
		...
		key: _verticesFrom,
		value: _regeneratorRuntime.mark(function value(from) {
			...
			return _regeneratorRuntime.wrap(function value$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						...
						context$2$0.prev = 4;
						_iterator8 = _getIterator(this[_edges].get(from).keys());
   ...
   */
		...
		key: _verticesTo,
		value: _regeneratorRuntime.mark(function value(to) {
			...
			return _regeneratorRuntime.wrap(function value$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						...
						context$2$0.prev = 4;
						_iterator9 = _getIterator(this[_reverseEdges].get(to));
   ...
   */
		...
		value: function verticesWithPathFrom(from) {
			this[_expectVertices](from);
			return this[_verticesWithPathFrom](from, new _Set());
		}
	}, {
		key: _verticesWithPathFrom,
		value: _regeneratorRuntime.mark(function value(from, done) {
			...
			return _regeneratorRuntime.wrap(function value$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						...
						context$2$0.prev = 3;
						_iterator10 = _getIterator(this[_edges].get(from).keys());
   ...
   */
		...
		value: function verticesWithPathTo(to) {
			this[_expectVertices](to);
			return this[_verticesWithPathTo](to, new _Set());
		}
	}, {
		key: _verticesWithPathTo,
		value: _regeneratorRuntime.mark(function value(to, done) {
			...
			return _regeneratorRuntime.wrap(function value$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						...
						context$2$0.prev = 3;
						_iterator11 = _getIterator(this[_reverseEdges].get(to));
   ...
   */
		...
		key: "sources",
		value: _regeneratorRuntime.mark(function sources() {
			var done, _iteratorNormalCompletion12, _didIteratorError12, _iteratorError12, _iterator12, _step12, key;

			return _regeneratorRuntime.wrap(function sources$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						done = new _Set();
						...
						context$2$0.prev = 4;
						_iterator12 = _getIterator(this[_sources]);
   ...
   */
		...
		key: "sinks",
		value: _regeneratorRuntime.mark(function sinks() {
			var done, _iteratorNormalCompletion13, _didIteratorError13, _iteratorError13, _iterator13, _step13, key;

			return _regeneratorRuntime.wrap(function sinks$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						done = new _Set();
						...
						context$2$0.prev = 4;
						_iterator13 = _getIterator(this[_sinks]);
   ...
   */
		...
		value: _regeneratorRuntime.mark(function vertices_topologically() {
			...
			return _regeneratorRuntime.wrap(function vertices_topologically$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						visit = function visit(a) {
							...
							return _regeneratorRuntime.wrap(function visit$(context$3$0) {
								while (1) switch (context$3$0.prev = context$3$0.next) {
									...
									case 5:
										...
										context$3$0.prev = 9;
										_iterator14 = _getIterator(_this.verticesTo(a));
						...
						marked2$0 = [visit].map(_regeneratorRuntime.mark);
						visited = [];
						handled = new _Set();
						_this = this;
						...
						context$2$0.prev = 8;
						_iterator15 = _getIterator(this.vertices());
   ...
   */
		...
		value: function clearEdges() {
			...
			try {
				for (var _iterator16 = _getIterator(this.edges()), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
   ...
   */
		...
		value: function clear() {
			...
			try {
				for (var _iterator17 = _getIterator(this.vertices()), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
   ...
   */
		...
		value: function equals(other) {
			...
			return (function () {
				...
				try {
					for (var _iterator18 = _getIterator(this.vertices()), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
				...
				try {
					for (var _iterator19 = _getIterator(this.edges()), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
   ...
   */
		...
		key: "cycles",
		value: _regeneratorRuntime.mark(function cycles() {
			...
			return _regeneratorRuntime.wrap(function cycles$(context$2$0) {
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						backtrack = function backtrack(v) {
							...
							return _regeneratorRuntime.wrap(function backtrack$(context$3$0) {
								while (1) switch (context$3$0.prev = context$3$0.next) {
									case 0:
										pointStack.push(v);
										mark.add(v);
						...
						marked2$0 = [backtrack].map(_regeneratorRuntime.mark);
						pointStack = [];
						...
						context$2$0.prev = 8;
						_iterator20 = _getIterator(this.vertices());
   ...
   */
		...
		key: _paths,
		value: _regeneratorRuntime.mark(function value(from, to) {
				...
				while (1) switch (context$2$0.prev = context$2$0.next) {
					case 0:
						pathsFromPrefix = function pathsFromPrefix(current) {
							...
							return _regeneratorRuntime.wrap(function pathsFromPrefix$(context$3$0) {
								while (1) switch (context$3$0.prev = context$3$0.next) {
									case 0:
										stack.push(current);
										...
										context$3$0.prev = 4;
										_iterator21 = _getIterator(_this.verticesFrom(current));
						...
						marked2$0 = [pathsFromPrefix].map(_regeneratorRuntime.mark);
						stack = [];
						_this = this;
   ...
   */
		...
		value: function mergeIn(other, mV, mE) {
			...
			try {
				for (var _iterator22 = _getIterator(other.vertices()), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
			...
			try {
				for (var _iterator23 = _getIterator(other.edges()), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
   ...
   */
		...
		value: function transitiveReduction(trV, trE) {
			...
			try {
				for (var _iterator24 = _getIterator(this.vertices()), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
					...
					try {
						for (var _iterator25 = _getIterator(this.vertices()), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
							...
							if (result.hasEdge(x, y)) {
								...
								try {
									for (var _iterator26 = _getIterator(this.vertices()), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
   ...
   */
		...
		value: function contractPaths() {
			...
			var nexuses = new _Set([].concat(_toConsumableArray(this.vertices())).filter(function (_ref) {
			...
			/* error if there is a branch-less cycle */
			{
				...
				(function () {
					var unhandledVertices = new _Set([].concat(_toConsumableArray(_this2.vertices())).map(function (_ref4) {
					...
					var checkForBlCycle = function checkForBlCycle(key) {
						...
						try {
							for (var _iterator27 = _getIterator(_this2.verticesFrom(key)), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
						...
						try {
							for (var _iterator28 = _getIterator(_this2.verticesTo(key)), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
					...
					try {
						for (_iterator29 = _getIterator(nexuses); !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
			...
			/* bookkeeping */
			var contractionsToAdd = new _Map();
			...
			var startPath = function startPath(start, next, backwards) {
				...
				/* bookkeeping */
				var verticesToRemove = new _Set();
				var edgesToRemove = new _Set();
				var path = new Graph();
				...
				if (!contractionsToAdd.get(fromTo()[0])) {
					contractionsToAdd.set(fromTo()[0], new _Map());
				}
				...
				try {
					for (var _iterator30 = _getIterator(edgesToRemove), _step30; !(_iteratorNormalCompletion30 = (_step30 = _iterator30.next()).done); _iteratorNormalCompletion30 = true) {
				...
				try {
					for (var _iterator31 = _getIterator(verticesToRemove), _step31; !(_iteratorNormalCompletion31 = (_step31 = _iterator31.next()).done); _iteratorNormalCompletion31 = true) {
			...
			try {
				for (var _iterator32 = _getIterator(nexuses), _step32; !(_iteratorNormalCompletion32 = (_step32 = _iterator32.next()).done); _iteratorNormalCompletion32 = true) {
					...
					try {
						for (var _iterator34 = _getIterator(this.verticesFrom(first)), _step34; !(_iteratorNormalCompletion34 = (_step34 = _iterator34.next()).done); _iteratorNormalCompletion34 = true) {
					...
					try {
						for (var _iterator35 = _getIterator(this.verticesTo(first)), _step35; !(_iteratorNormalCompletion35 = (_step35 = _iterator35.next()).done); _iteratorNormalCompletion35 = true) {
			...
			try {
				for (var _iterator33 = _getIterator(contractionsToAdd), _step33; !(_iteratorNormalCompletion33 = (_step33 = _iterator33.next()).done); _iteratorNormalCompletion33 = true) {
					...
					try {
						for (var _iterator36 = _getIterator(toVal), _step36; !(_iteratorNormalCompletion36 = (_step36 = _iterator36.next()).done); _iteratorNormalCompletion36 = true) {
   ...
   */
		...
		value: function toJSON() {
			...
			try {
				for (var _iterator37 = _getIterator(this.vertices()), _step37; !(_iteratorNormalCompletion37 = (_step37 = _iterator37.next()).done); _iteratorNormalCompletion37 = true) {
			...
			try {
				for (var _iterator38 = _getIterator(this.edges()), _step38; !(_iteratorNormalCompletion38 = (_step38 = _iterator38.next()).done); _iteratorNormalCompletion38 = true) {
   ...
   */
		...
		value: function value(key) {
			...
			try {
				for (var _iterator39 = _getIterator(this.verticesFrom(key)), _step39; !(_iteratorNormalCompletion39 = (_step39 = _iterator39.next()).done); _iteratorNormalCompletion39 = true) {
			...
			try {
				for (var _iterator40 = _getIterator(this.verticesTo(key)), _step40; !(_iteratorNormalCompletion40 = (_step40 = _iterator40.next()).done); _iteratorNormalCompletion40 = true) {
...
Graph.VertexExistsError = (function (_Error) {
   ...
   */
		...
		this.vertices = new _Set(vertices);
